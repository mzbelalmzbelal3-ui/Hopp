...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Notice from Owner চাঁদের পাহাড় «\n\n${c}, You are stupid for cursing bots so bots automatically banned you from the system`
	};
    //Add curse words without capital letters
	["bot mc", "Mc bot", "Chutiya bot", "Bsdk bot", "Bot teri maa ki chut", "Jhatu bot", "ভোদার বট", "🍼", "চাপড়ি বট", "Bot lund", "চাঁদের পাহাড় মায় রে বাপ", "Mc চাঁদের পাহাড়", "বোকাচোদা", "fuck bot", "চাঁদের পাহাড় লুচ্চা", "তোর বস লুচ্চা", "useless bot", "বট চুদি", "এই মাগি", "bc bot", "🤮", "বাল দাও", "হেড়ার বট", "বালের বট", "এই সালা", "cmm bot", "clap bot", "🖕🖕🖕🖕", "🖕🖕🖕", "🖕🖕", "🖕", "cc bot", "bot tiki", "lozz bottt", "lol bot", "সাওয়া", "ফেক", "boder bot", "এটা ফেক", "মাগি", "মাগি সর", "খানকির পোলা", "bot sudi", "Bot sida", "bot Bal", "bot fake", "সর", "সর বাল", "bad bot", "bot cau"].forEach((a => {
