...
module.exports.run = async function({ api, event }) {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ 𒀱⃝⃞⃟✡️🅱🅴🅻🅰🅻 🅱🅾🆃❤⃝⃞⃟𒀱ꪳ এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন চাঁদের পাহাড় কে নক করতে পারেন ★
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫: https://www.facebook.com/mahi.gaming.165
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: 01312893012
...
➤ কোন ধরনের সমস্যা হলে অ্যাডমিন চাঁদের পাহাড় এর সাথে যোগাযোগ ✡️
...
💌 🌺 আমাদের গ্রুপের সাথেই থাকবেন 🌺 💌
╭─╼╾─╼🌸╾─╼╾───╮
 ✡️⋆⃝চাঁদেড়~পাহাড়✿⃝✡️
╰───╼╾─╼🌸╾─╼╾─╯
